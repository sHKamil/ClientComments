...
class Clientcomments extends Module
{
            ...
            'form' => [
                ...
                'input' => [
                    ...
                    [
                        ...
                        'name' => 'CLIENTCOMMENTS_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ],
                    [
                        'type' => 'password',
                        'name' => 'CLIENTCOMMENTS_ACCOUNT_PASSWORD',
    ...
    protected function getConfigFormValues()
    {
        return [
            ...
            'CLIENTCOMMENTS_ACCOUNT_EMAIL' => Configuration::get('CLIENTCOMMENTS_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'CLIENTCOMMENTS_ACCOUNT_PASSWORD' => Configuration::get('CLIENTCOMMENTS_ACCOUNT_PASSWORD', null),
        ];
    }
